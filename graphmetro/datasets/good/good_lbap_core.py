...
class GOODLBAPcore(InMemoryDataset):
    r"""
    ...
    def __init__(self, root: str, domain: str = 'size', shift: str = 'no_shift', subset: str = 'train', transform=None,
                 pre_transform=None, generate: bool = False):
    ...
    @staticmethod
    def load(dataset_root: str, domain: str = 'size', shift: str = 'no_shift', generate: bool = False):
        r"""
