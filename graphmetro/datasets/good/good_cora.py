...
class GOODCora(InMemoryDataset):
    ...
    def __init__(self, root: str, domain: str = 'degree', shift: str = 'no_shift', transform=None, pre_transform=None,
                 generate: bool = False):
    ...
    @staticmethod
    def load(dataset_root: str, domain: str = 'degree', shift: str = 'no_shift', generate: bool = False):
        r"""
