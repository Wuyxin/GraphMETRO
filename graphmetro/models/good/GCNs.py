...
class GCN(torch.nn.Module):
    ...
    Args:
        config (Union[CommonArgs, Munch]): munchified dictionary of args (:obj:`dim_inner`, :obj:`config.model.model_layer`, :obj:`config.dataset.dim_node`, :obj:`config.dataset.num_classes`)
    """
    ...
    def __init__(self, dim_inner, dim_out, 
        ...
        super().__init__()
        self.encoder = GCNFeatExtractor(dim_inner)
...
class GCNFeatExtractor(torch.nn.Module):
    r"""
    ...
    def __init__(self, dim_inner):
        super(GCNFeatExtractor, self).__init__()
        self.encoder = GCNEncoder(dim_inner)
...
class GCNEncoder(BasicEncoder):
    ...
    def __init__(self, dim_inner):
        ...
        self.conv1 = GCNConv(-1, dim_inner)
        self.convs = nn.ModuleList(
            [
                GCNConv(dim_inner, dim_inner)
...
class GCNConv(gnn.GCNConv):
    ...
    def propagate(self, edge_index: Adj, size: Size = None, **kwargs):
        ...
        # Otherwise, run both functions in separation.
            ...
            if self._explain:
                edge_mask = self._edge_mask.sigmoid()
